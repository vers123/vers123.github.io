...
> **注意**：其他热门游戏导航页正在开发中，目前已添加Minecraft。后续将陆续添加英雄联盟、无畏契约、Apex 英雄、堡垒之夜、守望先锋2 等热门游戏的官方导航链接。

| 游戏名称 | 类型 | 官网链接 |
|---------|------|---------|
| Minecraft | 沙盒建造 | [官网](https://www.minecraft.net) |
...
- 🌐 添加了网站英文版本（miHoYo_EN.html、another_games_EN.html）
- 📝 将原 README.md 重命名为 README_CN.md
- ✅ 创建新的 README.md 作为语言选择入口页面
- ✅ 更新 index.html 添加中英文版本链接
- ✅ 完善项目文档，支持中英双语

### v2.0 (2025-12-23)

- 🚀 项目重大更新
- ✨ 在 Another Game 导航页添加 Minecraft 游戏内容
- ✨ 添加 Minecraft 和 Microsoft Logo 图片资源
- ✨ 更新 README.md，说明已添加 Minecraft
- ✅ 完成项目全面检查和验证
- ✅ 所有页面功能正常，图片资源完整
